...
namespace LteCar.Onboard.Hardware
{
    ...
    public class Pca9685GpioModuleManager : IModuleManager, IDisposable
    {
        ...
        public Pca9685GpioModuleManager(ILogger<Pca9685GpioModuleManager> logger, int i2cBus, int boardAddress)
        {
            _logger = logger;
            I2cBus = i2cBus;
            BoardAddress = boardAddress;
            var settings = new I2cConnectionSettings(I2cBus, BoardAddress);
